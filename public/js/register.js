...
function validateForm() {
    ...
    if (username.trim() === '') {
        ...
        emoji.innerHTML = `<img src="/images/sticker_5.png" alt="" style="width:  80%; margin: auto;">`;
    ...
    if (!/[A-Z]/.test(firstLetter)) {
        ...
        emoji.innerHTML = `<img src="/images/sticker_10.png" alt="" style="width:  80%; margin: auto;">`;
        submitBtn.classList.add('redBtn');
        return false;
    }
    ...
    if (username.length < 5) {
        ...
        emoji.innerHTML = `<img src="/images/sticker_21.png" alt="" style="width:  80%; margin: auto;">`;
        submitBtn.classList.add('redBtn');
        return false;
    }
    ...
    if (/[\(\){}\[\]\|`¬¦!"£$%^&*"<>\:\;#~_\-+=,@\.]/.test(username)) {
        ...
        emoji.innerHTML = `<img src="/images/sticker_23.png" alt="" style="width:  80%; margin: auto;">`;
        submitBtn.classList.add('redBtn');
        return false;
    }
    ...
    if (/\s/.test(username)) {
        ...
        emoji.innerHTML = `<img src="/images/sticker_16.png" alt="" style="width:  80%; margin: auto;">`;
        submitBtn.classList.add('redBtn');
        return false;
    }
    ...
    if (!email.match(emailPattern)) {
        ...
        emoji.innerHTML = `<img src="/images/sticker_9.png" alt="" style="width:  80%; margin: auto;">`;
        submitBtn.classList.add('redBtn');
        return false;
    }
    ...
    if (/(.)\1/.test(password)) {
        ...
        emoji.innerHTML = `<img src="/images/sticker_6.png" alt="" style="width:  80%; margin: auto;">`;
        submitBtn.classList.add('redBtn');
        return false;
    }
    ...
    if (password.trim() === '') {
        ...
        emoji.innerHTML = `<img src="/images/sticker_4.png" alt="" style="width:  80%; margin: auto;">`;
        submitBtn.classList.add('redBtn');
        return false;
    }
    ...
    if (password.length < 8) {
        ...
        emoji.innerHTML = `<img src="/images/sticker_13.png" alt="" style="width:  80%; margin: auto;">`;
        submitBtn.classList.add('redBtn');
        return false;
    }
    ...
    if (password !== passwordRepeat) {
        ...
        emoji.innerHTML = `<img src="/images/sticker_14.png" alt="" style="width:  80%; margin: auto;">`;
        submitBtn.classList.add('redBtn');
        return false;
    }
...
function checkFormError() {
    ...
    emoji.innerHTML = `<img src="/images/sticker_7.png" alt="" style="width:  80%; margin: auto;">`;
